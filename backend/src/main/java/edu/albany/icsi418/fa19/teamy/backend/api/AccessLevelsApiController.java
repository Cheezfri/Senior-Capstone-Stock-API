...
@Controller
public class AccessLevelsApiController implements AccessLevelsApi {

    private static final Logger log = LoggerFactory.getLogger(AccessLevelsApiController.class);
    ...
    public AccessLevelsApiController(ObjectMapper objectMapper, HttpServletRequest request) {
        this.objectMapper = objectMapper;
        this.request = request;
    }

    public ResponseEntity<List<AccessLevel>> accessLevelsGet() {
        ...
        if (accept != null && accept.contains("application/json")) {
            ...
            if (!accessLevels.isEmpty()) {
                ...
                return new ResponseEntity<List<AccessLevel>>(HttpStatus.NOT_FOUND);
            }
        } else {
            return new ResponseEntity<List<AccessLevel>>(HttpStatus.INTERNAL_SERVER_ERROR);
        }
    }
