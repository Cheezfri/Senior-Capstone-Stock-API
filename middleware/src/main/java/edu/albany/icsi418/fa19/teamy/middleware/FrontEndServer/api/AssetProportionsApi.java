...
@Api(value = "assetProportions", description = "the assetProportions API")
public interface AssetProportionsApi {

    @ApiOperation(value = "", nickname = "assetProportionsGet", notes = "get the list of transactions related to a portfolio", response = AssetProportion.class, responseContainer = "List", tags={  })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "Found one or more assets in the portfolio", response = AssetProportion.class, responseContainer = "List"),
