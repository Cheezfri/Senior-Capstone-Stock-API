...
import edu.albany.icsi418.fa19.teamy.middleware.BackEndClient.model.AccessRole;
import io.swagger.v3.oas.annotations.media.Schema;
import java.io.IOException;
/**
 * Access levels of the users
 */
@Schema(description = "Access levels of the users")
...
public class AccessLevel {
  ...
  **/
   ...
   * @return name
  **/
  @Schema(example = "Administrator", description = "Plain language name of the role")
