...
@Api(value = "portfolioTransaction_delete", description = "the portfolioTransaction_delete API")
public interface PortfolioTransactionDeleteApi {

    @ApiOperation(value = "", nickname = "portfolioTransactionDeletePost", notes = "delete a portfolio transaction", tags={  })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "Transaction is deleted"),
    ...
    @RequestMapping(value = "/portfolioTransaction_delete",
