...
@Api(value = "portfolioShare_add", description = "the portfolioShare_add API")
public interface PortfolioShareAddApi {

    @ApiOperation(value = "", nickname = "portfolioShareAddPost", notes = "Share a portfolio with an another user", tags={  })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "Portfolio has been Shared"),
        @ApiResponse(code = 500, message = "An error occurred processing this request") })
    @RequestMapping(value = "/portfolioShare_add",
